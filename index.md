...
-  ***nutrition*** : Nutritional information in a recipe. In particular, I will be looking at *protein (PDV)*, *calories (#)*, *total fat (PDV)*, and *carbohydrates (PDV)*.
...
The following table is the first 5 rows of the cleaned dataframe, with most of the columns omitted due to constraints in space.

|   | rating | avg_rating | calories (#) | total fat (PDV) | sodium (PDV) | protein (PDV) | saturated fat (PDV) | carbohydrates (PDV) |
|---|--------|------------|--------------|-----------------|--------------|---------------|--------------------|--------------------|
| 0 | 4.0    | 4.0        | 138.4        | 10.0            | 3.0          | 3.0           | 19.0               | 6.0                |
| 1 | 5.0    | 5.0        | 595.1        | 46.0            | 22.0         | 13.0          | 51.0               | 26.0               |
| 2 | 5.0    | 5.0        | 194.8        | 20.0            | 32.0         | 22.0          | 36.0               | 3.0                |
| 3 | 5.0    | 5.0        | 194.8        | 20.0            | 32.0         | 22.0          | 36.0               | 3.0                |
| 4 | 5.0    | 5.0        | 194.8        | 20.0            | 32.0         | 22.0          | 36.0               | 3.0                |
